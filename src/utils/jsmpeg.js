...
JSMpeg.Decoder.MPEG1Video = (function () {
  ...
  MPEG1.prototype.decodeMacroblock = function () {
    ...
    // Decode blocks
    var cbp =
      (this.macroblockType & 0x02) !== 0 ? this.readHuffman(MPEG1.CODE_BLOCK_PATTERN) : this.macroblockIntra ? 0x3f : 0
